...
if __name__ == "__main__":
    ...
    V = np.random.choice(np.arange(80, 160), size = args.train_N + args.test_N)
    A = gen_graphs(V)
    ...
    np.save("datasets/community_big/train_A.npy", A[train_idxs])
    np.save("datasets/community_big/train_E.npy", E[train_idxs])
    np.save("datasets/community_big/train_V.npy", V[train_idxs])

    np.save("datasets/community_big/test_A.npy", A[test_idxs])
    np.save("datasets/community_big/test_E.npy", E[test_idxs])
    np.save("datasets/community_big/test_V.npy", V[test_idxs])

    np.save("datasets/community_big/mu.npy", mu)
    np.save("datasets/community_big/sigma.npy", sigma)
